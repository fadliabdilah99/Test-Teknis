        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">{{$jabatan->unitKerja->nama . ' - ' . $jabatan->jabatan}}</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="add-row" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($jabatan->pegawai as $index => $pegawai)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $pegawai->nip }}</td>
                                    <td class="text-center"><img
                                            src="{{ asset('storage/fotoPegawai/' . $pegawai->foto) }}" alt="..."
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <button type="button" wire:click="delete({{ $pegawai->id }})"
